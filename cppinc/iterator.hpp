					     ...
					     typename Container::value_type>
{
	...
	/// The pointee member is owned and managed by the Container which is
	/// why
	...
	//===----------------------------------------------------------------------===//
      ...
      public:
	vector_iterator() {}
	/// explicit constructor used for converting to the underlying pointer
	/// type
